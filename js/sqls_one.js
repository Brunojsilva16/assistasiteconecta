...
$(".btn-modalidade_one").on("click", function (e) {
    e.preventDefault();
    ...
    switch (form_escolha) {
        ...
        case 'Profissional':
            ...
            $.post('./forms/lote_dados_frm.php', function (retorna) {
                ...
                $("#value-lote-select").val("427,00");
                $(".mod_select").text(form_escolha);
                $(".lote_select").text('427,00');
        ...
        case 'Parceiro':            // element.remove();
            $.post('./forms/lote_dados_frm.php', function (retorna) {
                ...
                $("#value-mod-select").val(form_escolha);
                $("#value-lote-select").val('341,60');
                $(".mod_select").text(form_escolha);
                $(".lote_select").text('341,60');
        ...
        case 'Estudante':            // element.remove();
            $.post('./forms/lote_dados_frm.php', function (retorna) {
                ...
                $("#value-mod-select").val(form_escolha);
                $("#value-lote-select").val('320,25');
                $(".mod_select").text(form_escolha);
                $(".lote_select").text('320,25');
            ...
            success: function (response) {
                ...
                if (response.error) {
                    ...
                    $.post('./forms/lote_resumo.php', function (retorna) {
                        ...
                        const elementcont = document.getElementById("inputone");
                        ...
                        switch (pagForm.get('mod_select')) {
                            ...
                            case 'Profissional':
                                ...
                                botao.innerHTML = "<a href='https://pag.ae/7_p6yBkr3/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                                break;

                            case 'Parceiro':

                                var botao = document.getElementById('botaopagamento');
                                botao.innerHTML = "<a href='https://pag.ae/7_p6Dxcm3/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                                break;

                            case 'Estudante':

                                var botao = document.getElementById('botaopagamento');
                                botao.innerHTML = "<a href='https://pag.ae/7_p6HQh13/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                                break;
                        }
            ...
            if (response.error) {
                ...
                switch (mcompra) {
                    ...
                    case 'Profissional':
                        ...
                        botaodesc.innerHTML = "<a href='https://pag.ae/7_p6BDwg4/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar-laranja.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                        break;

                    case 'Parceiro':

                        var botaodesc = document.getElementById('botaopagamento');
                        botaodesc.innerHTML = "<a href='https://pag.ae/7_p6Fn8w4/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar-laranja.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                        break;

                    case 'Estudante':

                        var botaodesc = document.getElementById('botaopagamento');
                        botaodesc.innerHTML = "<a href='https://pag.ae/7_p6MQmcK/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar-laranja.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                        break;
                }
