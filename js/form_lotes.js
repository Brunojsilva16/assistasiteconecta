    ...
    switch (form_escolha) {
        ...
        case 'Profissional':
            ...
            $.post('./forms/lote_dados_frm.php', function (retorna) {
                ...
                $("#value-lote-select").val("487,00");
                $(".mod_select").text(form_escolha);
                $(".lote_select").text('487,00');
        ...
        case 'Parceiro':            // element.remove();
            $.post('./forms/lote_dados_frm.php', function (retorna) {
                ...
                $("#value-mod-select").val(form_escolha);
                $("#value-lote-select").val('389,60');
                $(".mod_select").text(form_escolha);
                $(".lote_select").text('389,60');
        ...
        case 'Estudante':            // element.remove();
            $.post('./forms/lote_dados_frm.php', function (retorna) {
                ...
                $("#value-mod-select").val(form_escolha);
                $("#value-lote-select").val('365,25');
                $(".mod_select").text(form_escolha);
                $(".lote_select").text('365,25');
        ...
        case 'Grupo':            // element.remove();
            $.post('./forms/lote_dados_grupo.php', function (retorna) {
                ...
                $("#value-mod-select").val(form_escolha);
                $("#value-lote-select").val('438,30');
                $(".mod_select").text(form_escolha);
                $(".lote_select").text('438,30');
                    ...
                    $.post('./forms/lote_resumo.php', function (retorna) {
                        ...
                        switch (pagForm.get('mod_select')) {
                            ...
                            case 'Profissional':
                                ...
                                botao.innerHTML = "<a href='https://pag.ae/7_bPTiFnP/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' />";
                                break;

                            case 'Parceiro':

                                var botao = document.getElementById('botaopagamento');
                                botao.innerHTML = "<a href='https://pag.ae/7_bPVqxwa/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                                break;

                            case 'Estudante':

                                var botao = document.getElementById('botaopagamento');
                                botao.innerHTML = "<a href='https://pag.ae/7_bPXP8jo/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                                break;
                        }
            ...
            if (response.error) {
                ...
                switch (mcompra) {
                    ...
                    case 'Profissional':
                        ...
                        botaodesc.innerHTML = "<a href='https://pag.ae/7_bPUt_nP/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar-laranja.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                        break;

                    case 'Parceiro':

                        var botaodesc = document.getElementById('botaopagamento');
                        botaodesc.innerHTML = "<a href='https://pag.ae/7_bPWp-S3/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar-laranja.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' />";
                        break;

                    case 'Estudante':

                        var botaodesc = document.getElementById('botaopagamento');
                        botaodesc.innerHTML = "<a href='https://pag.ae/7_bQ7KNB6/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar-laranja.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                        break;
                }
