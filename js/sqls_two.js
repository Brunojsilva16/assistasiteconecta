...
$(".btn-modalidade_two").on("click", function (e) {
    e.preventDefault();

    const form_escolha = verificar('lotetwo_radio');
    ...
    switch (form_escolha) {
        ...
        case 'Profissional':
            ...
            $.post('./forms/lote_dados_frm.php', function (retorna) {
                ...
                $("#value-lote-select").val("477,00");
                $(".mod_select").text(form_escolha);
                $(".lote_select").text('477,00');
        ...
        case 'Parceiro':            // element.remove();
            $.post('./forms/lote_dados_frm.php', function (retorna) {
                ...
                $("#value-mod-select").val(form_escolha);
                $("#value-lote-select").val('381,60');
                $(".mod_select").text(form_escolha);
                $(".lote_select").text('381,60');
        ...
        case 'Estudante':            // element.remove();
            $.post('./forms/lote_dados_frm.php', function (retorna) {
                ...
                $("#value-mod-select").val(form_escolha);
                $("#value-lote-select").val('357,25');
                $(".mod_select").text(form_escolha);
                $(".lote_select").text('357,25');
        ...
        case 'Grupo':            // element.remove();
            $.post('./forms/lote_dados_grupo.php', function (retorna) {
                ...
                $("#value-mod-select").val(form_escolha);
                $("#value-lote-select").val('329,30');
                $(".mod_select").text(form_escolha);
                $(".lote_select").text('329,30');
                    ...
                    $.post('./forms/lote_resumo.php', function (retorna) {
                        ...
                        switch (pagForm.get('mod_select')) {
                            ...
                            case 'Profissional':
                                ...
                                botao.innerHTML = "<a href='https://pag.ae/7_pbotsm4/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                                break;

                            case 'Parceiro':

                                var botao = document.getElementById('botaopagamento');
                                botao.innerHTML = "<a href='https://pag.ae/7_pbpuGr1/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                                break;

                            case 'Estudante':

                                var botao = document.getElementById('botaopagamento');
                                botao.innerHTML = "<a href='https://pag.ae/7_pbqhp64/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                                break;
                        }
            ...
            if (response.error) {
                ...
                switch (mcompra) {
                    ...
                    case 'Profissional':
                        ...
                        botaodesc.innerHTML = "<a href='https://pag.ae/7_tDTGBg6/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar-laranja.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                        break;

                    case 'Parceiro':

                        var botaodesc = document.getElementById('botaopagamento');
                        botaodesc.innerHTML = "<a href='https://pag.ae/7_tDVUs-q/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar-laranja.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                        break;

                    case 'Estudante':

                        var botaodesc = document.getElementById('botaopagamento');
                        botaodesc.innerHTML = "<a href='https://pag.ae/7_tEj6jzo/button' target='_blank' title='Pagar com PagBank'><img src='//assets.pagseguro.com.br/ps-integration-assets/botoes/pagamentos/205x30-pagar-laranja.gif' alt='Pague com PagBank - é rápido, grátis e seguro!' /></a>";
                        break;
                }
