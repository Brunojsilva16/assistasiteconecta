<div>
    <p style="font-size: 30px; font-weight:700">Resumo da compra</p>
</div>
...
<div>
    <p style="font-size: 22px; font-weight:700">Nome do participante: <br> <span class="resumoSpan" id="mpartipante"></span></p>
    <p style="font-size: 22px; font-weight:700">Modalidade da compra: <br> <span class="resumoSpan" id="mcompra"></span></p>
    ...
    <div style="margin: 10px 0px;" class="col-12 align-self-start upp doww">
        <div class="row align-self-start">
            ...
            <div class="col-12 upp">
                ...
                <span class="txbotaopagamento">Pague clicando no botão abaixo:</span><br>
                <div id="botaopagamento">



                    <div class="col-12 upp">
                        <button id="resumolote_one" class="btn btn-success">Continuar para pagamento</button>
                        <!-- <input id="sbmlote_one" type="submit" class="btn btn-success" value="Continuar" /> -->
                        <h5 style="margin-top: 10px; opacity: 0.6;">Até 4x sem juros</h5>
                        <h5 style="margin-top: 10px; opacity: 0.6;">De 5 a 10x com juros PagSeguro</h5>
