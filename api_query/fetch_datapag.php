...
try {
    ...
    if ($numParticipantes > 0) {
        ...
        $htmlOutput = "<div class='table-responsive'>
			...
			<thead>
				<tr>
					<td colspan='6' align='center' style='color: #fff; text-transform: uppercase;' ><b>Tabela dos Participantes por ordem de pagamento<b> </td>
				</tr>
				<tr>
        ...
        foreach ($participantes as $row) {
            ...
            $dataCadastroFormatada = date_format(date_create($row['data_pag']), 'd/m/Y - H:i');
