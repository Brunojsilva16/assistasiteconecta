...
try {
	...
	$sql = "SELECT * FROM `$nomeTabela`
			WHERE `status_insc` IN ('Confirmado', 'Isento') AND `check_in` = 0
	...
	if ($numParticipantes > 0) {
		...
		$htmlOutput = "<div class='table-responsive'>
			...
			<thead>
				<tr>
					<td colspan='7' align='center' style='color: #fff; text-transform: uppercase;' ><b>Tabela dos Participantes com Check-in Pendente<b> </td>
				</tr>
				<tr>
