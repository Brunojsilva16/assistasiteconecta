...
<thead>
	<td colspan='7' align='center' style='color: #af2846; text-transform: uppercase;' ><b>Tabela dos Participantes confirmado<b> </td>
</thead>
<thead>
...
$sql = "SELECT * FROM `te_inscricao` WHERE `status_insc` = 'Confirmado' ORDER BY `nome_insc` ASC";
...
while ($row = $resultConut->fetch(PDO::FETCH_ASSOC)) {
	...
	$dados .=  "<tr>
		...
		<td class='text-center' width='180px'>R$ " . $row['valor_insc'] . "</td>
