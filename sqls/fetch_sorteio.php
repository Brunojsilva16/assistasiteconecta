...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'sortear') {
    try {
        ...
        $sql = "SELECT nome_insc FROM `inscricao` WHERE `sorteio` = 'Sim' ORDER BY RAND() LIMIT 1";
    ...
    try {
        ...
        $stmt = "SELECT nome_insc FROM `inscricao` WHERE `sorteio` = 'Sim' ORDER BY nome_insc ASC";
