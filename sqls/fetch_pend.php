...
<thead>
	<td colspan='8' align='center' style='color: #af2846; text-transform: uppercase;' ><b>Tabela dos Participantes sem pagamento confirmado<b> </td>
</thead>
<thead>
...
$sql = "SELECT * FROM `inscricao` WHERE status_insc is null ORDER BY `datacad` DESC";
...
while ($row = $resultConut->fetch(PDO::FETCH_ASSOC)) {
    ...
    $dados .=  "<tr>
		...
		<td class='text-center' width='200px'> $acao </td>
	</tr>";
}
