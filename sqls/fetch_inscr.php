...
$sql = "SELECT * FROM `inscricao` ORDER BY `datacad` DESC";
...
while ($row = $resultConut->fetch(PDO::FETCH_ASSOC)) {
    ...
    $botao_del = '<button type="button" onclick="get_delete(this);" class="btn btn-outline-danger" data-page="subpage-Wilson1-1" data-bd="inscricao" data-idbd="id_insc" data-id="' . $row['id_insc'] . '"><i class="fa-solid fa-trash"></i></button>';
