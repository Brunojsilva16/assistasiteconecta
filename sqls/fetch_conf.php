...
<thead>
	<td colspan='8' align='center' style='color: #af2846; text-transform: uppercase;' ><b>Tabela dos Participantes confirmado<b> </td>
</thead>
<thead>
...
$sql = "SELECT * FROM `inscricao` WHERE `status_insc` = 'Confirmado' ORDER BY `nome_insc` ASC";
