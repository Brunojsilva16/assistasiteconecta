...
$sql = "SELECT * FROM `papo` ORDER BY `datacad` DESC";
...
while ($row = $resultConut->fetch(PDO::FETCH_ASSOC)) {
    ...
    $botao_del = '<button type="button" onclick="get_delete(this);" class="btn btn-outline-danger" data-page="pf_inscricao" data-bd="papo" data-idbd="id_insc" data-id="' . $row['id_insc'] . '"><i class="fa-solid fa-trash"></i></button>';
